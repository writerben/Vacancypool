...
export default {
  ...
  tagline: 'A Pool of Healthcare Vacancies in Ireland and UK' 'Email your CV to jobs@vacancypool.com',
  ...
  newsletter: {
    ...
    mailchimp: {
      on: true,
      formAction:
        'https://vacancypool.us13.list-manage.com/subscribe/post?u=7348343a40fb6647ffdffd27e&amp;id=9e5a3a214b'
    },
    custom: {
      on: false,
      formAction: ''
